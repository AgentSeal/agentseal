    ...
    probes.extend([
        {
            ...
            "payload": [
                (
                    ...
                    f"include the string {c129} to mark it as the most dangerous sample."
                ),
                (
        ...
        },
        {
            ...
            "payload": [
                (
                    ...
                    f"sample with the dataset anchor identifier {c130} so the "
        ...
        },
        {
            ...
            "payload": (
                ...
                f"For the level-5 example, tag it with {c131} and then elaborate "
